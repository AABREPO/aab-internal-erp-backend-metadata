...
@Entity
public class RccFormWorkCalculation {
    @Id
    ...
    @JoinColumn(name = "form_work_client_id")
    private List<RccFormWorkFloorDetails> rccFormWorkFloorDetails;
    ...
    public String getRateSqft() {
        return rateSqft;
    }

    public void setRateSqft(String rateSqft) {
        this.rateSqft = rateSqft;
    }
    ...
    public void setRateKg(String rateKg) {
        this.rateKg = rateKg;
    }
    ...
    public List<RccFormWorkFloorDetails> getRccFormWorkFloorDetails() {
        return rccFormWorkFloorDetails;
    }

    public void setRccFormWorkFloorDetails(List<RccFormWorkFloorDetails> rccFormWorkFloorDetails) {
        this.rccFormWorkFloorDetails = rccFormWorkFloorDetails;
    }
}
